...
// $query="INSERT INTO `exitform`(`Name`, `Email`, `Mobile no`, `Video`, `department`, `suggestion`, `project title`, `end date`, `start date`, `experience`,`guidance`,`culture`)  VALUES 
// ('$name','$email','$mobile','$Video','$department','$suggestion','$projecttitle','$enddate','$startdate','$experience','$guidance','$culture')";
// echo $query;
// $result = mysqli_query($conn , $query) or die (mysqli_error($conn)); 
// $vax=$_SESSION['name'];
// $query = "SELECT * FROM exitform WHERE Name = '$vax' "  ;
