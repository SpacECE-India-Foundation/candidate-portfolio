...
$query = "SELECT * FROM upload WHERE file_uploader= '$currentuser' ORDER BY file_uploaded_on DESC";
...
?>
 ...
 <?php
    ...
    if (isset($_GET['del'])) {
        ...
        $del_query = "DELETE FROM upload WHERE file_id='$note_del' AND file_uploader = '$file_uploader' ";
