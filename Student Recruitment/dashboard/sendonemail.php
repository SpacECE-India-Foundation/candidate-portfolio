...
';
    ...
    $file_path_pdf='\\JoiningLetter-'.$_SESSION['name'].'-'.$contact['contact'].'.pdf';
	$pdf->Output(__DIR__.$file_path_pdf, 'F');


$fname='JoiningLetter-'.$_SESSION['name'].'-'.$contact['contact'].'.pdf';
$to = $_SESSION['uname'];
$subject = 'JoiningLetter-'.$_SESSION['name'].'-'.$contact['contact'];

$att = file_get_contents( __DIR__.$file_path_pdf);
...
$file_pointer = __DIR__.$file_path_pdf;
